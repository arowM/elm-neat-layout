...
import Mixin
import Neat.Flow as Flow exposing (Flow)
        ...
        View view_ ->
            View <|
                case view_ of
                    ...
                    FromFlows texts_ ->
                        FromFlows { texts_ | nominalGap = g2 }
...
setNodeName str view =
    case view of
        ...
        View (FromFlows texts_) ->
            View <|
                FromFlows
                    { texts_ | nodeName = Just str }
